...
import cn.edu.sjtu.wangyangyang.kotlinChatter.ChattStore.postChatt
import cn.edu.sjtu.wangyangyang.kotlinChatter.databinding.ActivityPostBinding
...
class PostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view.cameraButton.setOnClickListener {
            viewState.imageUri=mediaStoreAlloc("image/jpeg")
            cameraResult.launch(viewState.imageUri)
        }


        val videoResult = registerForActivityResult(ActivityResultContracts.CaptureVideo()) {
            viewState.videoIcon = android.R.drawable.presence_video_busy
            view.videoButton.setImageResource(viewState.videoIcon)
        }
        ...
        view.videoButton.setOnClickListener {
            ...
            videoResult.launch(viewState.videoUri)
        }
    }
